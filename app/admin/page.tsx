...
import { Users, Activity, Wallet, Coins, Clock, AlertTriangle } from "lucide-react";
                        ...
                        {withdrawal.status === 'Pending' ? (
                          <>
                            <button 
                              ...
                              className="text-xs px-2 py-1 rounded-lg bg-green-400/10 text-green-400 hover:bg-green-400/20 disabled:opacity-50"
                            >
                              Approve
                            </button>
                            <button 
                              ...
                              disabled={isActionLoading}
                              className="text-xs px-2 py-1 rounded-lg bg-red-400/10 text-red-400 hover:bg-red-400/20 disabled:opacity-50"
                            >
                              Reject
                            </button>
                          </>
