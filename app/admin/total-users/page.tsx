...
function LoadingBar() {
  ...
  return (
    <div className="w-full h-1 bg-primary/20 overflow-hidden rounded-full">
      <div 
...
export default function TotalUsers() {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const newUsersCount = data.users.filter((user: User) => 
        new Date(user.createdAt) > thirtyDaysAgo
      ).length;
      
      const activeUsersCount = data.users.filter((user: ExtendedUser) => 
        user.isVerified
      ).length;
      
      const suspendedUsersCount = data.users.filter((user: ExtendedUser) => 
        !user.isVerified
      ).length;
        ...
        <div className="absolute inset-0 bg-background/80 backdrop-blur-sm z-50 flex flex-col items-center justify-center">
          <div className="w-full max-w-2xl px-6">
            ...
            <div className="mt-8 space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="bg-background/80 border rounded-xl p-6 shadow-sm">
                    <div className="flex justify-between items-center">
                      <div>
                        <div className="h-4 w-24 bg-primary/10 rounded mb-2 animate-pulse"></div>
                        <div className="flex items-baseline gap-2">
              ...
              <div className="bg-background/80 border rounded-xl p-6 shadow-sm">
                <div className="flex justify-between items-center mb-6">
                  <div className="h-6 w-32 bg-primary/10 rounded animate-pulse"></div>
                  <div className="h-10 w-64 bg-primary/10 rounded-lg animate-pulse"></div>
                </div>
                  ...
                  {[...Array(8)].map((_, i) => (
                    <div key={i} className="border rounded-lg p-4">
                      ...
                      <div className="space-y-2">
                        {[...Array(3)].map((_, j) => (
                          <div key={j} className="flex justify-between">
                            <div className="h-3 w-16 bg-primary/10 rounded animate-pulse"></div>
                      ...
                      <div className="mt-4 pt-4 border-t flex justify-end gap-2">
                        {[...Array(3)].map((_, j) => (
                          <div key={j} className="h-6 w-12 bg-primary/10 rounded-md animate-pulse"></div>
                        ))}
                      </div>
                    </div>
                  ))}
            ...
            <p className="text-center text-primary mt-8 font-medium">Loading user data, please wait...</p>
          </div>
        </div>
      )}
