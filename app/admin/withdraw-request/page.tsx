    ...
    <div className="space-y-6 p-4 md:p-6">
        ...
        <div className="p-6">
          ...
          {isTableLoading ? (
            <div className="space-y-4">
              ...
              <p className="text-center text-green-600 font-medium">Loading withdrawal requests...</p>
            </div>
          ) : error ? (
            <div className="text-center py-8 text-red-500">{error}</div>
          ) : requests.length === 0 ? (
      ...
      {selectedRequest && isActionModalOpen && (
        <WithdrawalModal
          ...
          onStatusUpdate={(id, status, remarks) => handleStatusUpdate(id, status, remarks, "admin-user-id")}
          userId="admin-user-id"
        />
      )}
    </div>
